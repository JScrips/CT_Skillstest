      ...
      <div className="radius-for-skewed bg-orange-500 py-20">
        ...
        <div className="container mx-auto px-4 pt-8">
          ...
          <div className="text-center">
            <a
              className="inline-block rounded-l-xl rounded-t-xl bg-green-600 py-2 px-6 font-bold leading-loose text-gray-50 transition duration-200 hover:bg-green-700"
              href="#"
            >
              View More Projects
            </a>
          ...
          <div className="radius-for-skewed bg-orange-500 py-20">
            <div className="container mx-auto px-4">
              <div className="items-center justify-center md:space-x-8 lg:flex">
                ...
                <button className="hidden rounded-full bg-white p-5 text-green-600 shadow-md transition duration-200 hover:text-green-400 lg:block">
                  <svg
                    className="h-6 w-6"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
