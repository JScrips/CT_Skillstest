...
const Contact = () => {
  return (
    <section className="scroll-smooth bg-forge-bg">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="-mx-4 flex flex-wrap">
              ...
              <div className="-mx-4 flex flex-wrap">
                <div className="mb-10 w-full px-4 md:w-1/2">
                  <div className="mx-auto max-w-xs">
                    <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-full bg-forge-primary">
                      <svg
                        className="h-6 text-forge-acc"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        fill="none"
                    ...
                    <h3 className="mb-4 text-2xl font-bold leading-9 text-white md:text-3xl">
                      Email
                    </h3>
                    <a
                      className="hover:text-coolGray-500 text-lg font-medium text-forge-acc md:text-xl"
                      href="mailto:#"
                    >
                      contact@codeforge.agency
                    </a>
                  </div>
                </div>
                <div className="mb-10 w-full px-4 md:w-1/2">
                ...
                <div className="w-full px-4 md:w-1/2">
                  <div className="mx-auto max-w-xs">
                    ...
                    <h3 className="mb-9 text-2xl font-bold leading-9 text-white md:text-3xl">
                      Socials
                    </h3>
                    <a
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="rounded-md bg-forge-bg px-4 py-8 md:p-10">
                <form>
                  <div className="mb-6">
                    <label className="mb-2 block font-medium leading-6 text-forge-primary">
                      Email
                    </label>
                    <input
